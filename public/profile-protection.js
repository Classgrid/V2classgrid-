/**
 * Classgrid Profile Page Protection
...
(function () {
    ...
    function protectProfilePage() {
        ...
        const isProfilePage = window.location.pathname.includes('classroom.html');
        ...
        if (isProfilePage) {
            ...
            if (!isLoggedIn) {
                ...
                sessionStorage.setItem('redirect_after_login', 'classroom.html');
    ...
    function populateProfilePage() {
        ...
        if (profileEmail) {
            profileEmail.textContent = userData.email || 'classgrid25@gmail.com or support@classgrid.in';
        }
